#ifndef CASTER_SWERVE_DRIVE_CONTROLLER__MARKER_VISUALIZE_HPP_
#define CASTER_SWERVE_DRIVE_CONTROLLER__MARKER_VISUALIZE_HPP_
...
public:
  ...
  MarkerVisualize() : marker_lifetime_(0, 0) {}

  void init(rclcpp_lifecycle::LifecycleNode::WeakPtr node_interface,
            const std::string &base_frame_id,
            const std::string &marker_topic_name, size_t num_modules,
            double visualization_update_period_sec);

  void
  publish_markers(const rclcpp::Time &stamp, double robot_vx, double robot_vy,
...
private:
  ...
  create_arrow_marker(int id, const rclcpp::Time &stamp, const std::string &ns,
  ...
  visualization_msgs::msg::Marker create_line_strip_marker(
      ...
      const std_msgs::msg::ColorRGBA &color, double scale_x = LINE_WIDTH);

  visualization_msgs::msg::Marker
  create_sphere_marker(int id, const rclcpp::Time &stamp, const std::string &ns,
                       const geometry_msgs::msg::Point &position, double radius,
                       const std_msgs::msg::ColorRGBA &color);

  visualization_msgs::msg::Marker
  create_text_marker(int id, const rclcpp::Time &stamp, const std::string &ns,
                     const std::string &text,
                     const geometry_msgs::msg::Point &position,
                     const std_msgs::msg::ColorRGBA &color, double scale_z);

  visualization_msgs::msg::Marker
  create_cube_marker(int id, const rclcpp::Time &stamp, const std::string &ns,
                     const geometry_msgs::msg::Pose &pose,
                     const geometry_msgs::msg::Vector3 &scale,
                     const std_msgs::msg::ColorRGBA &color);

  void
  add_delete_marker_action(visualization_msgs::msg::MarkerArray &marker_array,
                           int id, const std::string &ns);
  void add_delete_all_markers_in_ns_action(
      visualization_msgs::msg::MarkerArray &marker_array,
      const std::string &ns);

  std::optional<Point2D> get_line_intersection(Point2D p1, Point2D p2,
...
#endif // CASTER_SWERVE_DRIVE_CONTROLLER__MARKER_VISUALIZE_HPP_